...
public class GamePlayIII5 implements SceneInterface{
  ...
  public GamePlayIII5(MasterFile p, PFont liquid, PImage star){
  ...
  */
  ...
  public void handleMouseClicked(){
    ...
    */
    ...
    if( (labels2.get(0).isInside(p.mouseY, p.mouseY) == true) && (labels2.get(0).isInside(link.getCX(), link.getCY()) == true) ){
        
        p.changeScene(labels2.get(0).getTargetScene(10));
    }
